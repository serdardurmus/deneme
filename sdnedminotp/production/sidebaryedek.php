		...
		<ul class="nav side-menu">
			...
			<li><a><i class="fa fa-list-ul"></i> Liste İşlemleri <span class="fa fa-chevron-down"></span></a>
				<ul class="nav child_menu">
					...
					<li><a href="kullanicilistesi.php"> Öğretmen Listesi <span class="label label-success pull-right"></span></a></li>
					<li><a href="kullanicilistesi.php"> Personel Listesi <span class="label label-success pull-right"></span></a></li>
					<li><a href="liste-ogrenci.php"> Öğrenci/Veli Listesi <span class="label label-success pull-right"></span></a></li>
					<li><a href="kullanicilistesi.php"> Sınıf Listesi <span class="label label-success pull-right"></span></a></li>
					<li><a href="kullanicilistesi.php"> Okul Listesi <span class="label label-success pull-right"></span></a></li>
					<li><a href="kullanicilistesi.php"> Ders/Branş Listesi <span class="label label-success pull-right"></span></a></li>
					<li><a href="kullanicilistesi.php"> Yemek Listesi <span class="label label-success pull-right"></span></a></li>
				</ul>
			</li>
			<li><a><i class="fa fa-briefcase"></i> Dosya İşlemleri <span class="fa fa-chevron-down"></span></a>
				<ul class="nav child_menu">
					<li><a href="kirtasiyelistesi.php"> Kırtasiye Listesi <span class="label label-success pull-right"></span></a></li>
					<li><a href="#"> Yıllık Planlar <span class="label label-success pull-right"></span></a></li>
					<li><a href="#"> Zümre Tutanakları <span class="label label-success pull-right"></span></a></li>
					<li><a href="#"> Nöbetçilik Listesi <span class="label label-success pull-right"></span></a></li>
					<li><a href="#"> Öğretmen Ders Programı <span class="label label-success pull-right"></span></a></li>
					<li><a href="#"> Veli Toplantı Tutanakları <span class="label label-success pull-right"></span></a></li>
					<li><a href="#"> Ş.Ö.K. Tutanakları <span class="label label-success pull-right"></span></a></li>
					<li><a href="#"> Öğrenci Tanıma Anketi <span class="label label-success pull-right"></span></a></li>
					<li><a href="#"> Demirbaş Listeleri <span class="label label-success pull-right"></span></a></li>
					<li><a href="#"> Kitaplık Listeleri <span class="label label-success pull-right"></span></a></li>
				</ul>
			</li>
			<li><a href="duyuru.php"><i class="fa fa-info"></i> Anasayfaya Duyuru Gir <span class="label label-success pull-right"></span></a></li>
			<hr>
