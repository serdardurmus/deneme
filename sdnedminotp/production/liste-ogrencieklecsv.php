  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>Öğrenci Listesi Ekleme İşlemleri</h3>
      </div>      
    </div>
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="x_title">
              ...
              <a href="liste-ogrenciekle.php"><button class="btn btn-info"><i class="fa fa-user" aria-hidden="true"></i>  Tek Öğrenci Bilgisi Ekle</button></a>
              <a href="liste-ogrenci.php"><button class="btn btn-success"><i class="fa fa-undo" aria-hidden="true"></i>  Öğrenci Listesi</button></a></div>
                <div class="clearfix"></div>
              </div>
              ...
              <div class="">
                ...
                <br>
                 <div class="form-group">
                  ...
                  <button class="btn-primary btn" name="CSVileogrencikaydet" type="submit">CSV İle Aktar</button>
                </div>
              ...
              <p style="color: red;">Örnek bir dosya için .xlsx dosyasını inceleyiniz. <a href="../../sdimg/dosya/ogrencilistesi.xlsx"><button class="btn-default btn btn-xs" type="submit">Örnek Dosya İndir</button></p></a>
